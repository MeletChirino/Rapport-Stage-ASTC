...
SRI_MEMORY_MAP = {
    ...
    'MINIMCDS'        : (0xFB718000, MEMORY_SIZE_32KB,  MEMTYPE_RAM)
}
...
SPB_MEMORY_MAP = {
    ...
    'GETH_SNPS'     : (0xF001D000, MEMORY_SIZE_8KB),
...
# p.21 of TC36x_appx_um_v1.4.pdf, SCI = 16
sri_num_slaves = 17
# p.27 of TC36x_appx_um_v1.4.pdf, MCI = 0..9
sri_num_masters = 10
