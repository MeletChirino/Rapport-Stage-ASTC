...
Entre mis obligaciones administrativas esta instalar todo lo del computador, abrir mis cuentas de la empresa, ir a cenas, recibir instrucciones de superiores, hablar ingles con extranjeros, llenar el Jira, documentar todo en git, etc
%-------------------------- * Obligaciones Tecnicas * --------------------------------
\section{Obligaciones Tecnicas}
Mis obligaciones tecnicas se resumen en programar, encontrar bugs, corregirlos, volver a programar, etc etc
